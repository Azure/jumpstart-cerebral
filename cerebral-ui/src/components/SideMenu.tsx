import { DrawerProps, FluentProvider, shorthands, webLightTheme } from "@fluentui/react-components";
...
export const SideMenu: React.FC<NavDrawerProps> = (props: Partial<NavDrawerProps>) => {
